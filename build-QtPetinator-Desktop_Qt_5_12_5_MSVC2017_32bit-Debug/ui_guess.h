...
public:
    ...
    void setupUi(QDialog *Guess)
    {
        ...
        pushButton_No->setGeometry(QRect(600, 390, 280, 100));
        pushButton_No->setFont(font);
        label = new QLabel(Guess);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(570, 550, 251, 111));
        label->setFont(font);
    ...
    void retranslateUi(QDialog *Guess)
    {
        ...
        label->setText(QApplication::translate("Guess", "<p align=\"center\">\320\257 \320\264\321\203\320\274\320\260\321\216, <br/>\321\207\321\202\320\276 \321\215\321\202\320\276...</p>", nullptr));
